...
@EnableRedisHttpSession(redisNamespace = "ball:app:token")
public class HttpSessionConfig {
    public static final String TOKEN_NAME = "Ball-Token";
    ...
    static class MyHeaderHttpSessionStrategy extends HeaderHttpSessionIdResolver {
        ...
        public List<String> resolveSessionIds(HttpServletRequest request) {
            if (request.getRequestURI().equals("/app/entrance/login")) {
