 ...
 */
@Slf4j
public class SelfHttpMessageConverter extends AbstractGenericHttpMessageConverter<Object> {
    ...
    public SelfHttpMessageConverter() {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        try {
            ...
            throw new HttpMessageNotReadableException(strJson, inputMessage);
        }
